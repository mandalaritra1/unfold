...
the maintained :class:`~unfold.tools.unfolder_core.Unfolder` re-unfolds the
...
from unfold.tools.pairsplit_run2_inputs import PairSplitRun2Inputs, pair_split_binning
...
DEFAULT_INTERNAL_TRANSFER_DIRECTORY = Path(
    "/Users/aritra/Projects/smp_jetmass_run2/rivet/hadronic_prod/results/"
    "mgmlm_internal_trijet_20260802_v1/final_1000of1000"
)
