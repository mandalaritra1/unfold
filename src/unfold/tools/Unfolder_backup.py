...
class Unfolder:
    def __init__(self, groomed, closure = False, herwig_closure = False, do_syst = False, cms_label = "Internal"):
        ...
        self._load_data(filename_mc = './inputs/pythia_output_no_syst.pkl', filename_data = "./inputs/data_all.pkl", filename_herwig='./inputs/pythia_output_no_syst.pkl') #pythia in herwig as dummy, replace with actual herwig file
    ...
    def plot_systematic_fraction(self, syst_name = 'all'):
        ...
        for i, result in enumerate(self.normalized_results):
            ...
            plt.tight_layout()
            out_path = f'outputs/plots/uncertainties/summary_groomed_{i}.pdf' if self.groomed else f'outputs/plots/uncertainties/summary_ungroomed_{i}.pdf'
    ...
    def plot_purity_stability(self):
        ...
        hep.histplot(purity_unflattened[1], self.gen_mass_edges_by_pt[1], label = "Purity")
        hep.histplot(stability_unflattened[1], self.gen_mass_edges_by_pt[1], label = "Stability")
    ...
    def _load_data(self, filename_mc = 'latest_pkl/0508/mc_0508_full.pkl', filename_data = "latest_pkl/0508/data_0508_full.pkl", filename_herwig = 'latest_pkl/0508/herwig_0508_full.pkl'):
        ...
        self.bins.reco_mass_edges_by_pt = reco_mass_edges_by_pt
    ...
    def _perform_unfold(self, systematic = 'nominal', closure = False, herwig_closure = False):
        ...
        nPoint, tauMin, tauMax = 50, 1e-6, 1e+0   # coarse example range
    ...
    def _plot_response_mosaic_cms(
        ...
        *,
        ...
        fig.tight_layout()
        if self.groomed:
            plt.savefig("outputs/outputs/plots/unfold/response_groomed.pdf")
        else:
            plt.savefig("outputs/outputs/plots/unfold/response_ungroomed.pdf")
        return fig, ax
