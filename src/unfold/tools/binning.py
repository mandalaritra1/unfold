    ...
    def __init__(self, groomed):
        ...
        if not self.groomed:
            ...
            self.gen_mass_edges_by_pt = [[0.0, 10.0, 20.0, 30.0, 50.0, 70.0, 90.0, 110.0,1000], #pt bin 1
                                      [0.0, 10.0, 20.0, 30.0, 50.0, 70.0, 90.0, 110.0,1000],
                                      [0.0, 10.0, 20.0, 30.0, 50.0, 70.0, 90.0, 110.0, 130.0, 150.0, 1000], #pt bin 2
                                        [0.0, 10.0, 20.0, 30.0, 50.0, 70.0, 90.0, 110.0, 130.0, 150.0, 170.0, 200.0, 1000.0]]  #pt bin 3
            self.reco_mass_edges_by_pt = [
                [0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0, 90.0, 100.0, 110.0, 120.0,   1000.0], #pt bin 1
                [0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0, 90.0, 100.0, 110.0, 120.0, 1000.0], #pt bin 2
                [0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0, 90.0, 100.0, 110.0, 120.0, 130.0, 140.0, 150.0,  200.0, 1000.0], #pt bin 3
                [0.0, 5.0, 10.0, 15.0, 20.0, 25.0, 30.0, 40.0, 50.0, 60.0, 70.0, 80.0, 90.0, 100.0, 110.0, 120.0,130.0,140.0,150.0,160.0,170.0,185.0,200.0, 215.0, 1000.0]
            ]
