...
from unfold.systematics import RUN2_LUMI as ERA_LUMI_FBINV
...
def unfold_reco_display_edges(groomed, xmin):
    ...
    edges = np.asarray(
        ZJET_BINNINGS["rho_groomed_arcr2" if groomed else "rho_ungroomed_arcr2"].reco_edges_by_pt[PT_BIN_INDEX],
        dtype=float,
    )
