...
Run:     source .venv/bin/activate && python scripts/datamc/data_mc_rho_with_model.py
"""
...
from unfold.systematics import RUN2_LUMI as run2_lumi   # UL values; this file used to carry 41.53/59.74

rho_edges_g = list(ZJET_BINNINGS["rho_groomed_v2"].reco_edges_by_pt[0])
rho_edges_u = list(ZJET_BINNINGS["rho_ungroomed_v2"].reco_edges_by_pt[0])
