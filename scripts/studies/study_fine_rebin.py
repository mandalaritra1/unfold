...
Usage:
    source scripts/setup_root.sh && python scripts/studies/study_fine_rebin.py
"""
...
# Regularization methods, matching scripts/studies/study_regularization_grid.py. The
