...
cache in :mod:`unfold.tools.model_envelope`.  It consumes the audited
...
_SMP_ROOT = Path("/Users/aritra/Projects/smp_jetmass_run2")
DEFAULT_FINAL_ALL_DIRECTORY = (
    _SMP_ROOT
    / "rivet/hadronic_prod/results/mess_pairsplit_dijet_20260813_v1/final-all"
)
...
DEFAULT_CAMPAIGN_DIRECTORY = Path(
    "/Users/aritra/cernbox (2)/hadronic_model_prod_mess/"
    "mess_pairsplit_dijet_20260813_v1"
)
