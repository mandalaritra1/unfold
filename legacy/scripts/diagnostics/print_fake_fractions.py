...
runs no unfolding.
    ...
    python scripts/diagnostics/print_fake_fractions.py
    python scripts/diagnostics/print_fake_fractions.py --input inputs/zjet/rho/arc_r2/pythia_all.pkl --label PYTHIA
"""
