...
have no jackknife inputs, so it is the propagated input covariance.
    ...
    python scripts/studies/study_roounfold_bayes.py --channel zjet  --tag original --n-iter 4
    python scripts/studies/study_roounfold_bayes.py --channel dijet --year 2018 --n-iter 4
"""
