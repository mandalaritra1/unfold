...
scripts/plotting/plot_data_prior_unfolded_comparison.py redraw the comparison figures
later without ROOT or the heavy pickle.

    source scripts/setup_root.sh
    python scripts/studies/study_data_prior.py --weighted-mc /path/to/weighted_pythia.pkl
"""
...
def align_producer_axes(weighted, nominal, path: Path):
    ...
    unfold inputs (same trick as scripts/staging/stage_jmsjmr_unity_inputs.py, which
